    ...
    <>
      ...
      >
        <div
          ...
          onClick={collapse}
          className={cn(
            "size-6 text-muted-foreground rounded-sm hover:bg-neutral-300 dark:hover:bg-neutral-600 absolute top-3 right-2 opacity-0 group-hover:opacity-100 transition cursor-pointer",
